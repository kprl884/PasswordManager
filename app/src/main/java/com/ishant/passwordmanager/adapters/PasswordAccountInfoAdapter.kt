...
class PasswordAccountInfoAdapter(private val accountDetails: MutableList<EntryDetail>): RecyclerView.Adapter<PasswordAccountInfoAdapter.PasswordAccountInfoAdapterViewHolder>() {
